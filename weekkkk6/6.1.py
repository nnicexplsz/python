...
def menu():
    ...
    print('='*28,'\nเพิ่มข้อมูลของท่าน กด [a]\nแสดงข้อมูลผู้เสี่ยง COVID-19 [s]\nแก้ไขข้อมูลผู้เสี่ยง COVID-19 [e]\nลบข้อมูลผู้เสี่ยง COVID-19 [d]\nออกจากระบบ [x]')
    choice = input('\nกรุณาเลือกทำรายการ :')
...
def show():
    ...
    result = c.fetchall()
    print("-"*75)
    print('{0:<12}{1:<15}{2:<15}{3:<26}{4:<11}{5}'.format('ลำดับที่',' ชื่อ','สกุล','เลขบัตรประจำตัวประชาชน','อายุ','เพศ'))
    print("-"*75)
    for x in result :
